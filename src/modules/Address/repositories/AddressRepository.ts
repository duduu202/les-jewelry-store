...
class AddressRepository implements IAddressRepository {
  ...
  async create({ street, number, district, city, state, zip_code, user_id }: IAddressCreate): Promise<Address> {
  ...
  async update({ id, street, number, district, city, state, zip_code }: Address): Promise<Address> {
